...
import '../../pedido/services/pedido_service.dart';
...
class _RutaDetalleScreenState extends State<RutaDetalleScreen> {
  ...
  Future<void> _optimizarRuta() async {
    ...
    try {
      final optimizados = await _pedidoService.optimizeRoute(
        widget.ruta.id,
        originLat,
        originLng,
      );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          'Detalle de Ruta: ${widget.ruta.nombre}',
                  ...
                  child: ListTile(
                    ...
                    subtitle: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Pedido #${pedido.id} • ${Formatters.currency.format(pedido.total)}',
                          style: const TextStyle(
