...
class ProductoService {
  ...
  static const String _base = 'productos';
  ...
  Future<Map<String, dynamic>> importExcel(
    ...
    final response = await _http.multipart(
      'industria-california/producto/productos/import',
      files: [file],
    );
    return response as Map<String, dynamic>;
  }

  Future<Map<String, dynamic>> importExcelPorCategoria(
    int categoriaId,
    List<int> bytes,
    String filename,
  ) async {
    ...
    final response = await _http.multipart(
      'categorias/$categoriaId/productos/import',
      files: [file],
    );
    return response as Map<String, dynamic>;
  }
