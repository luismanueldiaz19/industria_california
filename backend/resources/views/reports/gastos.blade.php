        ...
        <table>
            <tr>
                ...
                <td class="report-info" style="width: 40%;">
                    <div class="report-title">Historial de Gastos</div>
    ...
    <table class="data-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $gasto->proveedor->name ?? 'N/A' }}</td>
            ...
            @empty
            <tr>
                <td colspan="9" class="text-center" style="padding: 20px;">No se encontraron registros de gastos con los filtros seleccionados.</td>
            </tr>
            @endforelse
        </tbody>
    </table>
        ...
        <div class="totals-container">
            <table class="totals-table">
                <tr class="grand-total">
                    <td class="label" style="color: white;">GRAN TOTAL GASTOS:</td>
